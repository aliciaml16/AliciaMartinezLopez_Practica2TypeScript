...
//Persona 1
var persona0 = new Persona("Ayelén", "Campos Hinojosa", 23, "12345678Z", "30 de julio", "Azul", "Mujer", [], [], [], "Le debo 12€ de la última comida.");
...
//Persona 2
var persona1 = new Persona("Noa", "Fierro Mojica", 43, "11223344B", "22 de febrero", "Amarillo", "Otro", [], [], [], "Amigue de la mamá. ¡Acordarse de felicitarle!");
...
//Persona 3
var persona2 = new Persona("Guillermo", "Rivera López", 19, "99887766P", "28 de mayo", "Verde", "Hombre", [], [], [], "Preparar su regalo de cumpleaños.");
